      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center space-y-8 z-10">
            ...
            >
              {[
                { icon: Atom, label: "BATAN" }, { icon: Microscope, label: "LIPI" },
                { icon: Cpu, label: "BPPT" }, { icon: Landmark, label: "PUSPIPTEK" },
              ].map((item, idx) => {
              ...
              <AnimatePresence mode="wait">
                {heroImages.length > 0 ? (
                  ...
                  >
                   ...
                   <div className="flex h-full items-center justify-center bg-slate-100 text-slate-400"><p>No Image</p></div>
                )}
              </AnimatePresence>
            </div>
          </div>
