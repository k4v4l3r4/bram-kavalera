      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_520px] gap-10 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-balance group transition-transform duration-700 ease-out">
              {["PURNABHAKTI", "BATAN · BPPT", "LIPI · PUSPIPTEK"].map((text, i) => (
                <motion.h2
                  ...
                  } text-blue-700 drop-shadow-[0_3px_6px_rgba(0,0,0,0.35)]`}
                  initial="hidden"
                  animate="visible"
                  variants={{
                    visible: {
            ...
            <p className="mt-4 text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed max-w-md mx-auto lg:mx-0">
              {data.subtitle}
            </p>
          ...
          <div className="w-full flex justify-center">
            <div className="relative w-full max-w-[520px] h-[360px] md:h-[480px] rounded-2xl overflow-hidden border border-white/20 backdrop-blur-md bg-white/10 shadow-xl">
              <AnimatePresence mode="wait">
                {data.images?.[activeIndex] && (
                  ...
                  >
                    <Image
                      src={urlFor(data.images[activeIndex])
                        .width(1600)
                        .auto("format")
                        .quality(85)
                        .url()}
